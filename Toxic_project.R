...
stowwords.custom <- c("put", "far", "bit", "well", "article", "articles", "edit", "edits", "page", "pages",
                      ...
                      "look", "one", "make", "come", "see", "said", "now", "wiki", "know", "talk", "read", "hey", "time", "still", "user", "day", "want", "tell", "edit", "even", "ain't", "wow", "image", "jpg", "copyright", "sentence", "wikiproject", "background color", "align", "px", "pixel",
                      ...
                      "doing", "would", "should", "could", "ought", "isn't", "aren't", "wasn't", "weren't", "hasn't", "haven't", "hadn't", "doesn't", "don't", "didn't", "won't", "wouldn't", "shan't", "shouldn't",
